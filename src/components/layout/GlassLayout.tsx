...
export const GlassLayout: React.FC<GlassLayoutProps> = ({ 
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      {/* Blurred Header */}
      <View className="absolute top-0 left-0 right-0 z-50 h-[100px] shadow-[0_4px_30px_rgba(255,43,60,0.1)]">
      ...
      <View className="absolute bottom-6 left-6 right-6 h-16 rounded-3xl overflow-hidden border border-primary/20 bg-[#131316]/60 shadow-[0_-10px_40px_rgba(255,43,60,0.05)]">
