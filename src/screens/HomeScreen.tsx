  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { paddingTop: insets.top + SPACING.sm }]}>
        <View>
          <Text style={styles.headerGreeting}>
            {user ? `Hi, ${user.username}` : 'ANIMEHUB'}
          </Text>
          <Text style={styles.headerSub}>ANIMEHUB // STREAM</Text>
        </View>
      ...
      {hero && (
        <TouchableOpacity
          style={styles.hero}
          onPress={() => navigation.navigate('AnimeDetail', { animeId: hero.id })}
          activeOpacity={0.92}
        >
          <Image
          ...
          <View style={styles.heroContent}>
            ...
            <View style={styles.heroButtons}>
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('EpisodesList', { animeId: hero.id, animeTitle: hero.title })}
              >
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.genrePills}>
          {GENRES.map((g) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('GenreBrowse', { genre: g })}
            >
...
const styles = StyleSheet.create({
  ...
  scanLines: {
    ...StyleSheet.absoluteFillObject,
    opacity: 0.04,
    backgroundColor: 'repeating-linear-gradient(0deg, transparent, transparent 2px, #fff 2px, #fff 4px)',
  },
  heroContent: {
    position: 'absolute',
